...
1. The first is from the document lines:
   ...
   * From the menu bar, select **Process** and then **Copy Authorized Lines to Jobsheet**. You have the option of creating a new jobsheet or merging it with an existing one; you can do either, depending on your preferences. 

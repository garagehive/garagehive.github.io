...
> Hi [CustName] , this is a reminder that according to our records your vehicle [Make] [Model] - [VehReg] is due an MOT on [MOTDueDate]. Please visit [docs.garagehive.co.uk](/docs/ "A example URL") to book online or call us on 02031461163 - Opt-out [OptOutURL]
